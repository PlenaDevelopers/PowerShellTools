<#
    Função: Limpar o Navegador Google Chrome
...
& $cabecalhoScriptPath -Script $scriptName -Titulo "Limpar o Navegador Google Chrome"
#----------------------------------------------------------------------------------------------
...
if ($chromeInstalled) {
    ...
    Write-Host "║" -NoNewline -ForegroundColor Cyan
    Write-Host ("{0,-30} : " -f "Status") -NoNewline -ForegroundColor cyan
    Write-Host ("{0,-86} " -f "Google Chrome não está instalado.") -NoNewline -ForegroundColor cyan
    Write-Host "║" -ForegroundColor Cyan
}
#----------------------------------------------------------------------------------------------
