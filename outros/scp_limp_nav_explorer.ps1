<#
    Função: Limpar o Navegador Microsoft Internet Explorer
...
& $cabecalhoScriptPath -Script $scriptName -Titulo "Limpar o Navegador Microsoft Internet Explorer"
#----------------------------------------------------------------------------------------------
...
if ($ieInstalled) {
    ...
    Write-Host ("{0,-86} " -f "Encerrando o Microsoft Internet Explorer") -NoNewline -ForegroundColor cyan
    ...
    Write-Host "║" -NoNewline -ForegroundColor Cyan
    Write-Host ("{0,-30} : " -f "Status") -NoNewline -ForegroundColor cyan
    Write-Host ("{0,-86} " -f "Microsoft Internet Explorer não está instalado.") -NoNewline -ForegroundColor cyan
    Write-Host "║" -ForegroundColor Cyan
}
#----------------------------------------------------------------------------------------------
