...
& $cabecalhoScriptPath -Script $scriptName -Titulo "Instalar Google Drive"
#----------------------------------------------------------------------------------------------

# Iniciar Ações
#----------------------------------------------------------------------------------------------
# URL do instalador do Google Drive
$url = "https://dl.google.com/drive-file-stream/GoogleDriveSetup.exe"
$installerPath = "C:\Temp\GoogleDriveSetup.exe"

Write-Host "║" -NoNewline -ForegroundColor Cyan
Write-Host ("{0,-30} : " -f "Aplicativo") -NoNewline -ForegroundColor White
Write-Host ("{0,-86} "   -f "Google Drive" ) -NoNewline -ForegroundColor Cyan
...
# Executar a instalação silenciosa com os parâmetros corretos
Start-Process -FilePath $installerPath -ArgumentList "--silent --desktop_shortcut" -Wait
#----------------------------------------------------------------------------------------------
