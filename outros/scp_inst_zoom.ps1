...
& $cabecalhoScriptPath -Script $scriptName -Titulo "Instalar Zoom"
#----------------------------------------------------------------------------------------------

# Iniciar Ações
#----------------------------------------------------------------------------------------------
# URL do instalador do Zoom
$url = "https://zoom.us/client/latest/ZoomInstaller.exe"
$installerPath = "C:\Temp\ZoomSetup.exe"

Write-Host "║" -NoNewline -ForegroundColor Cyan
Write-Host ("{0,-30} : " -f "Aplicativo") -NoNewline -ForegroundColor White
Write-Host ("{0,-86} "   -f "Zoom" ) -NoNewline -ForegroundColor Cyan
