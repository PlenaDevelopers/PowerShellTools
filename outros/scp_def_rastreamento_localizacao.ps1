<#
    Função: Habilitar/Desabilitar o rastreamento de localização
...
& $cabecalhoScriptPath -Script $scriptName -Titulo "Habilitar/Desabilitar o rastreamento de localização"
#----------------------------------------------------------------------------------------------
if ($opcao -eq "0") {
    $acao = "Desabilitar"
} elseif ($opcao -eq "1") {
...
Write-Host ("{0,-86} " -f ("Rastreamento de Localização: $acao")) -NoNewline -ForegroundColor White
...
Write-Host "║" -NoNewline -ForegroundColor Cyan
Write-Host ("{0,-30} : " -f "Valor") -NoNewline
Write-Host ("{0,-86} " -f ("DisableLocation: $regValue")) -NoNewline -ForegroundColor White
Write-Host "║" -ForegroundColor Cyan
#----------------------------------------------------------------------------------------------
