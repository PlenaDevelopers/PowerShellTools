<#
    Função: Habilitar/Desabilitar Atualizações Automáticas
...
& $cabecalhoScriptPath -Script $scriptName -Titulo "Habilitar/Desabilitar Atualizações Automáticas"
#----------------------------------------------------------------------------------------------
...
# Caminho do Registro para Atualizações Automáticas
