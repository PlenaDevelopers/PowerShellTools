<#
    Função: Converte formato de imagens
...
param(
        [string]$arquivo = "C:\Temp\JPG\foto-01.jpg",
        [string]$formato = "bmp"
    )
...
& $cabecalhoScriptPath -Script $scriptName -Titulo "Converte formato de imagens"
#----------------------------------------------------------------------------------------------
...
function Convert-ImageFormat {
    param(
        [string]$filePath = "C:\Temp\JPG\foto-01.jpg",
        [string]$targetFormat = "bmp"
    )
...
Convert-ImageFormat -filePath $arquivo -targetFormat $formato
#----------------------------------------------------------------------------------------------
