<#
    Função: Instalar Microsoft OneDrive
...
& $cabecalhoScriptPath -Script $scriptName -Titulo "Instalar Microsoft OneDrive"
#----------------------------------------------------------------------------------------------

# Iniciar Ações
#----------------------------------------------------------------------------------------------
# URL do instalador do OneDrive
$url = "https://go.microsoft.com/fwlink/p/?LinkID=2182910&clcid=0x416&culture=pt-br&country=br"
$installerPath = "C:\Temp\OneDriveSetup.exe"

Write-Host "║" -NoNewline -ForegroundColor Cyan
Write-Host ("{0,-30} : " -f "Aplicativo") -NoNewline -ForegroundColor White
Write-Host ("{0,-86} "   -f "OneDrive" ) -NoNewline -ForegroundColor Cyan
