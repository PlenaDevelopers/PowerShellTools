<#
    Função: Instalar Microsoft Teams
...
& $cabecalhoScriptPath -Script $scriptName -Titulo "Instalar Microsoft Teams"
#----------------------------------------------------------------------------------------------

# Iniciar Ações
#----------------------------------------------------------------------------------------------
# URL do instalador do Microsoft Teams
$url = "https://go.microsoft.com/fwlink/?linkid=2281613&clcid=0x416&culture=pt-br&country=br"
$installerPath = "C:\Temp\TeamsSetup.exe"

Write-Host "║" -NoNewline -ForegroundColor Cyan
Write-Host ("{0,-30} : " -f "Aplicativo") -NoNewline -ForegroundColor White
Write-Host ("{0,-86} "   -f "Microsoft Teams" ) -NoNewline -ForegroundColor Cyan
