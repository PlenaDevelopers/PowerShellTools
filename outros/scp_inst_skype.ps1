...
& $cabecalhoScriptPath -Script $scriptName -Titulo "Instalar Skype"
#----------------------------------------------------------------------------------------------

# Iniciar Ações
#----------------------------------------------------------------------------------------------
# URL do instalador do Skype
$url = "https://go.skype.com/windows.desktop.download"
$installerPath = "C:\Temp\SkypeSetup.exe"

Write-Host "║" -NoNewline -ForegroundColor Cyan
Write-Host ("{0,-30} : " -f "Aplicativo") -NoNewline -ForegroundColor White
Write-Host ("{0,-86} "   -f "Skype" ) -NoNewline -ForegroundColor Cyan
